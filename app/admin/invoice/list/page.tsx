...
import { Search, Eye, Edit2, Trash2, Download, PlusCircle, ChevronUp, ChevronDown } from "lucide-react";
import { StatusBadge } from "@/components/admin/Badge";
import Button from "@/components/admin/Button";
import { dummyInvoices, formatRupiah, Invoice } from "@/lib/admin-data";
import Link from "next/link";

type SortField = "invoiceNumber" | "customerName" | "invoiceDate" | "grandTotal" | "totalExpense" | "netProfit" | "status";
              ...
              {paginated.length === 0 ? (
                ...
                paginated.map((inv) => (
                  <tr key={inv.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-5 py-3.5 text-[13px] text-slate-600 whitespace-nowrap">{inv.invoiceDate}</td>
                    <td className="px-5 py-3.5">
